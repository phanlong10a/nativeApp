...
function ScanStack(props) {
  return (
    <Stack.Navigator initialRouteName="Scan" mode="card" headerMode="screen">
      <Stack.Screen
        name="Scan"
        component={scan}
        options={{
...
function AppStack(props) {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Scan" component={ScanStack} />
    </Drawer.Navigator>
  );
}
...
export default function OnboardingStack(props) {
  return (
    <Stack.Navigator mode="card" headerMode="none">
      ...
      <Stack.Screen name="Components" component={ComponentsStack} />
    </Stack.Navigator>
  );
}
